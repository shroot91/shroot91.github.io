...
final bodySmall = Styles(
    color: textDim,
    fontSize: 0.875.rem,
    fontWeight: FontWeight.w400,
    lineHeight: 1.3.em);
final bodyMedium = Styles(
    color: textDark,
    fontSize: 1.rem,
    fontWeight: FontWeight.w400,
    lineHeight: 1.6.em);
final bodyLarge = Styles(
    color: textDark,
    fontSize: 1.1.rem,
    fontWeight: FontWeight.w400,
    lineHeight: 1.7.em);
final caption =
Styles(color: primaryMid, fontSize: 1.2.rem, fontWeight: FontWeight.w800);
final caption2 = Styles(
    color: primaryMid,
    fontSize: 0.8.rem,
    fontWeight: FontWeight.w800,
    letterSpacing: 0.08.em);
final heading1 =
Styles(color: textBlack, fontSize: 4.rem, fontWeight: FontWeight.w800);
final heading2 =
Styles(color: textBlack, fontSize: 3.rem, fontWeight: FontWeight.w700);
final heading3 =
Styles(color: textBlack, fontSize: 2.5.rem, fontWeight: FontWeight.w700);
final heading4 =
Styles(color: textBlack, fontSize: 1.5.rem, fontWeight: FontWeight.w700);
final heading5 =
Styles(color: textBlack, fontSize: 1.rem, fontWeight: FontWeight.w600);
...
List<StyleRule> get root => [
  ...
  css('h1')
      .combine(heading1)
      .styles(margin: Margin.only(top: Unit.zero, bottom: 0.1.rem)),
  css('h2')
      .combine(heading2)
      .styles(margin: Margin.only(top: Unit.zero, bottom: 0.1.em)),
  css('h3')
      .combine(heading3)
      .styles(margin: Margin.only(top: Unit.zero, bottom: 0.1.em)),
  css('h4')
  ...
  css('.animated-underline', [
    css('&').styles(
      ...
      backgroundPosition:
      BackgroundPosition(offsetX: Unit.zero, offsetY: 100.percent),
